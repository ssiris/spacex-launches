    ...
    var getLaunches = function (data) {
        ...
        data.reverse().forEach(launch => {
            ...
            if (launch.launch_success) {
              list.innerHTML = list.innerHTML + '<li><a href="launch.html?id=' + launch.flight_number + '"><span class="short-item">#' + launch.flight_number + '<small> ✅</small></span><span>' + launch.mission_name + '</span><span class="hide-mobile">' + launch.rocket.rocket_name + '</span><span class="hide-mobile">' + payload + '</span><span>' + date.toLocaleDateString() + '</span></a></li>';
            }
            else {
