...
var getUpcomingLaunches = function () {
    ...
    var getLaunches = function (data) {
        ...
        data.forEach(launch => {
            ...
            list.innerHTML = list.innerHTML + '<li><a href="launch.html?id=' + launch.flight_number + '"><span class="short-item">' + launch.flight_number + '</span><span>' + launch.mission_name + '</span><span>' + launch.rocket.rocket_name + '</span><span>' + payload + '</span><span>' + date.toLocaleDateString() + '</span></a></li>';
        });
